...
from utils.utils import ALGOS, get_callback, get_callback_list, get_extractor_class, get_latest_run_id, get_wrapper_class, linear_schedule
...
class ExperimentManager:
    ...
    def _preprocess_hyperparams(
        ...
        ext_key = "features_extractor_class"
        pol_key = "policy_kwargs"
    ...
    def objective(self, trial: optuna.Trial) -> float:
        ...
        callbacks, __ = get_callback_list({"callback": self.specified_callbacks})
